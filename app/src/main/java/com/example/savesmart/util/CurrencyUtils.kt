...
object CurrencyUtils {
    ...
    /**
     * Formats milliunits to decimal string without currency symbol for EditText input.
     */
    fun formatMilliunitsNoCurrency(milliunits: Long): String {
        val rands = milliunitsToRands(milliunits)
        return "%.2f".format(Locale.US, rands)
    }
