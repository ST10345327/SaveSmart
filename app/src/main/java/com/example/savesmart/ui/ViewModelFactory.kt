...
class ViewModelFactory(private val repository: SaveSmartRepository) : ViewModelProvider.Factory {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>, extras: CreationExtras): T {
        ...
        return when {
            ...
            modelClass.isAssignableFrom(OnboardingViewModel::class.java) -> 
                OnboardingViewModel(repository, savedStateHandle) as T
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when {
            ...
            modelClass.isAssignableFrom(ReportsViewModel::class.java) -> 
                ReportsViewModel(repository) as T
            else -> throw IllegalArgumentException("OnboardingViewModel requires CreationExtras for SavedStateHandle. Use create(modelClass, extras).")
        }
    }
}
